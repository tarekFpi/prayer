       ...
       appBar: AppBar(
         ...
         leading: Builder(
           builder: (context) {
             return IconButton(
               onPressed: () => Get.back(),
               icon: Icon(Icons.arrow_back_rounded, color: AppColors.black,size: 32.w
                 ,),
             );
           },
         ),
                  ...
                  () {
                   return Column(
                     ...
                     children: [
                       ...
                       authController.verificationEmailLoading.value?Center(child: CircularProgressIndicator(color: AppColors.amber,)):
                       CustomButton(
                         onTap: () {
                           if(newTextEditingController.value.text==""){

                             Toast.errorToast("otp cannot be empty!");
