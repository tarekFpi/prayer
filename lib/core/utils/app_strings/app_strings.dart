class   AppStrings {
 ...
 ///======= splash screen =====================
  ...
  static const String title2 = "Motivation";
  static const String title3 = "Tracker";

  static const String reservationDetalis = "Alhumdulillah for everything";


  /// mood tracker --

  static const String feelSad =  "Feel Sad";

  static const String feelAnxious =  "Feel Anxious";

  static const String feelNervous =  "Feel Nervous";

  static const String feelDepressed =  "Feel Depressed";

  static const String feelHappy = "Feel Happy";

  static const String feelExcited = "Feel Excited";
